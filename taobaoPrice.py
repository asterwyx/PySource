...
def main():
    ...
    depth = 2
    start_url = "https://s.taobao.com/search?q=" + goods + "&imgfile=&js=1&stats_click=search_radio_all%3A1" \
                                                           "&initiative_id=staobaoz_20190724&ie=utf8&bcoffset=3" \
                                                           "&ntoffset=3&p4ppushleft=1%2C48 "
